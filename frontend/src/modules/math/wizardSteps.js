...
export const STEP_ORDER = ['inicio', 'tipo_sistema', 'cargas', 'seleccion', 'resultado', 'done'];
...
export function getNextStep(step, data) {
  switch (step) {
    ...
    case 'tipo_sistema':
      ...
      // SFV Autoconsumo, Híbrido y Bombeo Solar se habilitan en entregables posteriores.
      return null;
    case 'cargas':
      return 'seleccion';
    case 'seleccion':
